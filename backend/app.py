...
class SoundGuardApp:
    ...
    def run(self) -> None:
        ...
        try:
            while True:
                ...
                decision, should_speak = self.post_process_decision(decision)
    ...
    def post_process_decision(self, decision: DecisionResult) -> tuple[DecisionResult, bool]:
        """경고 순서, 응급 잠금, 상태 업데이트를 적용하고 (최종 decision, TTS 재생 여부) 반환."""
